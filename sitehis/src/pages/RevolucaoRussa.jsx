      ...
      <section className="bloco">
        <article className="c1">
          <p className="t1">
            ...
            governo não conseguiu atender às principais demandas do povo, como o
            fim da guerra, a distribuição de terras e melhores condições de
            vida. A insatisfação popular continuava alta.
          </p>
        </article>
        <article>
          <img
        ...
        <article>
          <img
            width="600px"
            height="400px"
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRy0cYGq9PdXy-2AsoXNivc2Gl6Cza5AUzMnA&s"
            alt="imagem2"
          />
        </article>
      </section>
      ...
      <section>
         ...
         <article>
          <img
            width="600px"
            height="400px"
            src="https://ogimg.infoglobo.com.br/in/21975364-e2c-6fe/FT1086A/72528758.jpg"
            alt="imagem3"
          />
        </article>
        <article>
          <img
            width="600px"
            height="400px"
            src="https://assets.brasildefato.com.br/2024/09/image_processing20200201-29235-1nfnxod.jpg"
            alt="imagem4"
          />
        </article>
        ...
        <article className="bloco"> 
          <p>
            A segunda fase da revolução ocorreu em outubro do mesmo ano e foi
            liderada por Vladimir Lênin e pelo Partido Bolchevique. Os
            bolcheviques organizaram uma insurreição armada e tomaram o poder,
            prometendo atender às reivindicações populares com o lema: “Paz,
            terra e pão”. Eles retiraram a Rússia da Primeira Guerra Mundial,
            começaram a distribuir terras aos camponeses e iniciaram a
            construção de um novo tipo de governo baseado no socialismo. Após a
            vitória dos bolcheviques, teve início uma guerra civil entre os
            apoiadores do novo regime comunista, chamados de “vermelhos”, e os
            opositores, conhecidos como “brancos”, que queriam restaurar o
            antigo regime. Os bolcheviques saíram vitoriosos e consolidaram seu
            poder. Em 1922, foi oficialmente criada a União das Repúblicas
            Socialistas Soviéticas (URSS), formada por várias repúblicas sob a
            liderança da Rússia. Esse novo Estado adotou uma economia
            planificada, estatizou indústrias e bancos, e buscou eliminar a
            propriedade privada dos meios de produção. A Revolução Russa teve um
            profundo impacto no mundo inteiro. Ela inspirou movimentos
            comunistas e socialistas em diversos países, influenciou guerras,
            revoluções e políticas durante todo o século XX, especialmente
            durante a Guerra Fria, quando a União Soviética se tornou uma das
            duas superpotências globais, ao lado dos Estados Unidos. Assim, a
            Revolução Russa não foi apenas um evento local, mas um divisor de
            águas na história mundial, que alterou radicalmente a política, a
            economia e as relações internacionais nos anos que se seguiram.
          </p>
        </article>
